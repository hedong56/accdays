...
public class AccumulationAction extends ActionSupport {
	...
	public String userInfo(){
		userInfo=accumulationService.getPersonInfo(id);
		return "userInfo";
	}
	...
	public String testdata(){
		accumulationService.savePersonInfo();
		List<User> personInfos=accumulationService.findAllPersonInfo();
		if(personInfos!=null){
			for (User personInfo : personInfos) {
